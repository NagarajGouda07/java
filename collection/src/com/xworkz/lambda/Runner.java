...
public class Runner {
	public static void main(String[] args) {
		 ...
		 * System.out.println("Binay operation: "+(a + b)); return (a + b); }; String
		 * result = binayOperator.apply("Hello", "World");
		 */
		...
		IntBinaryOperator intBinaryOperator = (value1, value2) -> { // used to perform addition, multiplication, maximum
																	// of two numbers
		...
		/*
		 * LongSupplier longSupplier = (value)->{ return value; };
